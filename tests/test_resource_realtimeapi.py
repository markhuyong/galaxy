...
from rest.resources import RealtimeApi, ServiceResource, CrawlResource
...
class TestRealtimeApi(unittest.TestCase):
    ...
    @patch('rest.resources.settings', deepcopy(settings))
    def test_realtimeapi_with_custom_settings(self):
        from rest.resources import settings
