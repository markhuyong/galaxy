...
class galaxyTestServer(BaseTestServer):

    def __init__(self, site=None, *args, **kwargs):
        super(galaxyTestServer, self).__init__(*args, **kwargs)
        self.arguments = [
            sys.executable, '-m', 'rest.cmdline', '-p', str(self.port)
        ]
        self.stderr = PIPE
    ...
    def stop(self):
        super(galaxyTestServer, self).stop()
